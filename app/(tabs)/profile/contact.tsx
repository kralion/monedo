...
import { Info, Linkedin } from "lucide-react-native";
      ...
      <View className="flex flex-col gap-6 px-4 py-8 ">
        <View className="flex flex-row gap-4 items-center ">
          ...
          <View className="flex flex-col gap-1">
            <Text className="font-bold text-xl">Info del Desarrollador</Text>

            <Text className="text-foreground">Brayan Paucar</Text>
